...
# Chrome WWDC Dropbox cheatsheet sourcetree transmit foxmail telegram slack
brew cask install google-chrome wwdc dropbox cheatsheet sourcetree transmit foxmail telegram slack
